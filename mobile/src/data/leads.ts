...
const images = {
  dayDate: require('../../assets/products/day-date-40.png'),
  datejustBlack: require('../../assets/products/datejust-41-black.png'),
  datejustChoc: require('../../assets/products/datejust-41-chocolate.png'),
};
